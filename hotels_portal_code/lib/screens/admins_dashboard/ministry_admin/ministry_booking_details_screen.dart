...
class MinistryBookingDetailsScreen extends StatefulWidget {
  final Booking booking;

  const MinistryBookingDetailsScreen({super.key, required this.booking});

  @override
  State<MinistryBookingDetailsScreen> createState() =>
      _MinistryBookingDetailsScreen();
}

class _MinistryBookingDetailsScreen
    extends State<MinistryBookingDetailsScreen> {
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    const MinistryAdminHeader(title: "Booking Details"),
                    Expanded(
