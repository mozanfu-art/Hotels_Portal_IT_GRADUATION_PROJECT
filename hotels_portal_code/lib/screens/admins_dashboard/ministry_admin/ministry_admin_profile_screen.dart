...
class MinistryAdminProfileScreen extends StatefulWidget {
  const MinistryAdminProfileScreen({super.key});

  @override
  State<MinistryAdminProfileScreen> createState() =>
      _MinistryAdminProfileScreenState();
}

class _MinistryAdminProfileScreenState
    extends State<MinistryAdminProfileScreen> {
              ...
              Expanded(
                child: Column(
                  children: [
                    ...
                    if (!isMobile)
                      const MinistryAdminHeader(title: "Profile Settings"),
                    Expanded(
